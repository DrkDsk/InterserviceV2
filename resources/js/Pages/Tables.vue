...
const rows = [
    ...
    { id: 6, company: 'Nova Health', contact: 'contact@novahealth.ai', plan: 'Enterprise', status: 'Active', mrr: '$11,200' },
        ...
        <AppCard>
            <div class="grid gap-4 p-5 lg:grid-cols-[1fr_0.8fr] lg:items-center">
                <div>
                    ...
                    <h3 class="mt-2 text-lg font-semibold text-slate-900 dark:text-slate-100">Focused on scanning, filtering, and actionability.</h3>
                    <p class="mt-2 text-sm leading-6 text-slate-500 dark:text-slate-400">
                        The table uses thin borders, calm hover states, and compact pagination controls to keep attention on the data itself.
                    </p>
                </div>
