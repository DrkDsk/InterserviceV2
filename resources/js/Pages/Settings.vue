    ...
    >
            ...
            <AppCard>
                ...
                <div class="space-y-4 p-5">
                    ...
                    >
                        ...
                        <span class="h-3 w-3 rounded-full" :class="theme === 'light' ? 'bg-primary-500' : 'bg-slate-300 dark:bg-slate-700'" />
                    </button>
                    ...
                    >
                        ...
                        <span class="h-3 w-3 rounded-full" :class="theme === 'dark' ? 'bg-primary-500' : 'bg-slate-300 dark:bg-slate-700'" />
                    </button>
                </div>
            </AppCard>
        </section>
        ...
        <section class="grid gap-4 xl:grid-cols-2">
            <AppCard>
                ...
                <div class="space-y-4 p-5">
                    <label class="flex items-center justify-between rounded-sm border border-slate-200 px-4 py-3 dark:border-slate-800">
                        <div>
                        ...
                        <input v-model="settings.weeklyDigest" type="checkbox" class="h-4 w-4 rounded-sm border-slate-300 accent-primary-500 focus:ring-primary-500/20 dark:border-slate-700">
                    </label>
                    ...
                    <label class="flex items-center justify-between rounded-sm border border-slate-200 px-4 py-3 dark:border-slate-800">
                        ...
                        <input v-model="settings.releaseNotes" type="checkbox" class="h-4 w-4 rounded-sm border-slate-300 accent-primary-500 focus:ring-primary-500/20 dark:border-slate-700">
                    </label>
                    ...
                    <label class="flex items-center justify-between rounded-sm border border-slate-200 px-4 py-3 dark:border-slate-800">
                        ...
                        <input v-model="settings.alerts" type="checkbox" class="h-4 w-4 rounded-sm border-slate-300 accent-primary-500 focus:ring-primary-500/20 dark:border-slate-700">
                    </label>
                </div>
            </AppCard>
                ...
                <div class="space-y-4 p-5 text-sm text-slate-600 dark:text-slate-300">
                    ...
                    <div class="grid gap-3 sm:grid-cols-3">
                        <div class="rounded-sm border border-slate-200 p-4 dark:border-slate-800">
                            ...
                            <p class="mt-2 text-sm font-medium text-slate-900 dark:text-slate-100">{{ settings.weeklyDigest ? 'On' : 'Off' }}</p>
                        </div>
                        <div class="rounded-sm border border-slate-200 p-4 dark:border-slate-800">
                            <p class="text-xs uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">Releases</p>
                            <p class="mt-2 text-sm font-medium text-slate-900 dark:text-slate-100">{{ settings.releaseNotes ? 'On' : 'Off' }}</p>
                        </div>
                        <div class="rounded-sm border border-slate-200 p-4 dark:border-slate-800">
                            <p class="text-xs uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">Alerts</p>
                            <p class="mt-2 text-sm font-medium text-slate-900 dark:text-slate-100">{{ settings.alerts ? 'On' : 'Off' }}</p>
                        </div>
                    </div>
