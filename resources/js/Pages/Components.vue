            ...
            <AppCard>
                <div class="p-5">
                    ...
                    <div class="mt-3 flex items-center gap-2">
                        <button class="rounded-sm border border-slate-200 p-2 text-slate-500 transition hover:bg-slate-50 hover:text-slate-900 dark:border-slate-800 dark:hover:bg-slate-900 dark:hover:text-slate-100">
        ...
        <AppCard>
            <div class="grid gap-4 p-5 lg:grid-cols-[1fr_auto] lg:items-center">
                <div>
                    ...
                    <h3 class="mt-2 text-lg font-semibold text-slate-900 dark:text-slate-100">A refined modal for confirmations</h3>
                    <p class="mt-2 text-sm leading-6 text-slate-500 dark:text-slate-400">
