...
const timeline = [
    { title: 'Design review approved', detail: 'Product team finalized the new onboarding flow.', time: '2 min ago', type: 'success' },
    { title: 'Billing sync completed', detail: 'Stripe metrics were updated successfully.', time: '18 min ago', type: 'primary' },
    { title: 'A/B experiment live', detail: 'New CTA treatment is now active on 12% of sessions.', time: '1 hour ago', type: 'secondary' },
    { title: 'API latency alert cleared', detail: 'Edge latency returned to normal after mitigation.', time: '3 hours ago', type: 'accent' },
];
            ...
            <AppCard>
                <div class="flex h-full flex-col justify-between gap-6 p-6">
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <h2 class="max-w-2xl text-3xl font-semibold tracking-tight text-slate-900 dark:text-slate-100 sm:text-4xl">
                            ...
                            <p class="max-w-2xl text-sm leading-6 text-slate-500 dark:text-slate-400 sm:text-base">
                                Designed for teams that value fast decisions, sharp visual hierarchy, and a refined interface that stays out of the way.
                            </p>
                        </div>
                    </div>
        ...
        <section class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <AppCard v-for="stat in kpis" :key="stat.label">
                <div class="flex items-center gap-4 p-5">
                    <div class="flex h-11 w-11 items-center justify-center rounded-sm bg-slate-100 text-slate-500 dark:bg-slate-800 dark:text-slate-300">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-800">
                    <thead class="bg-slate-50/70 dark:bg-slate-950/70">
                        <tr>
                            <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Account</th>
                            <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Plan</th>
                            <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Status</th>
                            <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Revenue</th>
                            <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">Owner</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                        <tr v-for="row in activityTable" :key="row.name" class="transition hover:bg-slate-50/70 dark:hover:bg-slate-900/80">
