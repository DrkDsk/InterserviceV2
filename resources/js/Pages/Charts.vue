...
<template>
  ...
  >
    ...
    <section class="grid gap-4 xl:grid-cols-2">
      <ChartPanel type="line" title="Traffic trend" description="A smooth line chart for weekly audience flow."
                  :data="lineData" :options="lineOptions"/>
      <ChartPanel type="bar" title="Order activity" description="Compact bars for a quick operational read."
                  :data="barData" :options="barOptions"/>
    </section>

    <section class="grid gap-4 xl:grid-cols-[0.95fr_1.05fr]">
      <ChartPanel type="pie" title="Department allocation" description="A restrained split across the core teams."
